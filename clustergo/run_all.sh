...
cd ~/old/fireman/repos/gci-simulator/clustergo
ENABLE_CCT=true LITTLE_OMEGA=0.0001 BIG_OMEGA=0.003 HT=-1  NREPLICAS=2,4,8,16,32,64 ./run_exp.sh
...
cd ~/old/fireman/repos/gci-simulator/clustergo
ENABLE_CCT=false BIG_OMEGA=0.03 HT=847.3845 HEDGE_CANCELLATION=true NREPLICAS=2,4,8,16,32,64 ./run_exp.sh
