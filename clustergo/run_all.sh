...
cd ~/old/fireman/repos/gci-simulator/clustergo
BIG_OMEGA=0.003 HT=0 NREPLICAS=2,4,8,16,32,64 ./run_exp.sh
...
cd ~/old/fireman/repos/gci-simulator/clustergo
BIG_OMEGA=0.003 HT=${HT} NREPLICAS=2,4,8,16,32,64 ./run_exp.sh
...
cd ~/old/fireman/repos/gci-simulator/clustergo
BIG_OMEGA=0.003 HT=${HT} HEDGE_CANCELLATION=true NREPLICAS=2,4,8,16,32,64 ./run_exp.sh
...
cd ~/old/fireman/repos/gci-simulator/clustergo
BIG_OMEGA=0.003 LITTLE_OMEGA=0.0001 ENABLE_CCT=true NREPLICAS=2,4,8,16,32,64 ./run_exp.sh
