...
ggplot(sim_data) +
  ...
  geom_errorbar(aes(x=n, ymin=pvn_mean-pvn_ic, ymax=pvn_mean+pvn_ic), width=0.4, colour="orange", alpha=0.9, size=1) +
  ylim(0,.5) +
  ggtitle("PVN using mean confidence interval")
ggsave("validation_pvn_30_900000.png")
...
ggplot(sim_data) +
  ...
  geom_errorbar(aes(x=n, ymin=pcp_mean-pcp_ic, ymax=pcp_mean+pcp_ic), width=0.4, colour="orange", alpha=0.9, size=1) +
  ylim(0,.5) +
  ggtitle("PCP using confidence interval")
ggsave("validation_pcp_30_900000.png")
```
