from .context import Clients, ServerWithGCI, getConfig
...
class TestGCI(unittest.TestCase):
    ...
    def test_interaction(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.0035 memory-0.69')
        clients_conf = getConfig('../data/config/clients.ini',
    ...
    def test_one_request_enough_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.0035 memory-0.7')
        clients_conf = getConfig('../data/config/clients.ini',
                                 'clients sleep_time-0.00001 create_request_rate-100 max_requests-1')
    ...
    def test_three_request_low_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.0035 memory-0.345')
        clients_conf = getConfig('../data/config/clients.ini',
    ...
    def test_three_request_enough_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.0035 memory-0.35')
        clients_conf = getConfig('../data/config/clients.ini',
    ...
    def test_small_queue_low_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.00035 memory-0.069')
        clients_conf = getConfig('../data/config/clients.ini',
    ...
    def test_small_queue_enough_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.00035 memory-0.07')
        clients_conf = getConfig('../data/config/clients.ini',
                                 'clients sleep_time-0.00001 create_request_rate-100 max_requests-11')
        num_requests, request_duration, request_memory = int(clients_conf['max_requests']), float(
            requests_conf['service_time']), float(requests_conf['memory'])
    ...
    def test_high_queue_low_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.000035 memory-0.0069')
        clients_conf = getConfig('../data/config/clients.ini',
    ...
    def test_high_queue_enough_heap(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.000035 memory-0.007')
        clients_conf = getConfig('../data/config/clients.ini',
                                 'clients sleep_time-0.00001 create_request_rate-100 max_requests-101')
        num_requests, request_duration, request_memory = int(clients_conf['max_requests']), float(
            requests_conf['service_time']), float(requests_conf['memory'])
    ...
    def test_multiples_gci_collects(self):
        requests_conf = getConfig('../data/config/request.ini', 'request service_time-0.001 memory-0.1')
        clients_conf = getConfig('../data/config/clients.ini',
